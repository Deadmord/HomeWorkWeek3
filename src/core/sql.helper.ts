...
export class SqlHelper {
    ...
    public static executeQueryNoResult(query: string, ignoreNoRowsAffected: boolean, ...params: (number | string)[]): Promise<void> {
    ...
    public static executeStoredProcedureSingleResult<T>(procedureName: string, ...params: (string | number | null)[]): Promise<T> {
        return new Promise<T>((resolve, reject) => {
            SqlHelper.openConnection()
                .then((connection) => {
                    const pm: ProcedureManager = connection.procedureMgr();
    ...
    public static executeStoredProcedureArrayResult<T>(procedureName: string, ...params: (string | number)[]): Promise<T[]> {
        return new Promise<T[]>((resolve, reject) => {
            SqlHelper.openConnection()
                .then((connection: Connection) => {
                    const pm: ProcedureManager = connection.procedureMgr();
