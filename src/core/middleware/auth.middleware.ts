...
class AuthMiddleware {
  public verifyToken1(req: Request, res: Response, next: NextFunction) {
    return res.status(200).send("verifyToken1");
  }

  public verifyToken2 = (req: Request, res: Response, next: NextFunction) => {
    return res.status(200).send("verifyToken2");
  }
